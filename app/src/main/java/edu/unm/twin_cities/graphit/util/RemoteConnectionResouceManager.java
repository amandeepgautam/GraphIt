...
public class RemoteConnectionResouceManager {
    ...
    public ConnectionResouceBundle getConnectionResource(BluetoothDevice bluetoothDevice, Context context) throws IOException {
        synchronized (resourceBundleMap) {
            ...
            return getResouceBundle(bluetoothDevice, bluetoothSocket);
        }
    }
     ...
     */
    public ConnectionResouceBundle refreshConnectionResource(BluetoothDevice bluetoothDevice, Context context) throws IOException {
        try {
            synchronized (resourceBundleMap) {
    ...
    private ConnectionResouceBundle getResouceBundle(BluetoothDevice bluetoothDevice, BluetoothSocket bluetoothSocket) throws IOException {
        ...
        ConnectionResouceBundle resourceBundle = new ConnectionResouceBundle(objectOutputStream, objectInputStream, bluetoothSocket);
